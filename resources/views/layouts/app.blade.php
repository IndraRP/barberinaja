...
<body class="bg-dark no-right-click text-gray-900">
    @if (!in_array(Route::currentRouteName(), ["tren.detail", "service.detail", "barberdetail", "bookingdetail", "history_detail", "form", "metodepembayaran", "konfirmasi", "login", "signup", "trendetail", "forgot-password", "password.reset", "forgot-password"]))
