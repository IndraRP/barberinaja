    ...
    <section class="px-3" style="margin-top:80px;">
        <div class="abu px-3 pb-4 mb-4 rounded border" style="border-color: #4343433a !important;">
            ...
            <div class="text-start">
                ...
                <div class="d-flex justify-content-between align-items-center p-1">
                    ...
                    <div class="text-end fs-10 m-0 text-white">{{ $detail['time'] ?? '-' }} WIB</div>
                </div>
            </div>
        </div>
        ...
        <div class="abu px-3 pb-4 mb-4 rounded border" style="border-color: #4343433a !important;">
            ...
            <div class="text-start">
                ...
                @if ($selected_discount && $selected_discount['discount_percentage'])
                    <div class="d-flex justify-content-between align-items-center p-2 rounded abu">
                        <div class="rounded text-success gap-y-0">
                            <p class="fs-10 m-0">Diskon</p>
                        </div>
                        <div class="text-end fs-10 m-0 text-success">
                            Rp
                            {{ number_format(($servicePrice * $selected_discount['discount_percentage']) / 100, 0, ',', '.') }}
                        </div>
                    </div>
                    @else
                    <div class="fs-10 text-danger p-2 abu">Anda Tidak mendapat Discount</div>
                @endif
        ...
        <div class="p-2 bawah fixed-bottom">
            <div class="d-flex justify-content-between align-items-center px-1" id="main-container">
                <div class="d-flex flex-column m-0" id="text-container">
                    <h1 class="fs-5 text-white m-0"> Rp {{ number_format(session('total_pembayaran'), 0, ',', '.') }}
                    </h1>
                </div>
            ...
            <div class="modal-content" style="background-color: #1e1e2d; color: #ffffff;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 fs-7 text-end ms-auto">Bank BRI</div>
                    </div>

                    <div class="row" onclick="copyToClipboard('{{ $nomer_rekening }}')" wire:click="showAlert">
                        <div class="col-5 fs-7 pt-1">No. Rekening</div>
                        <div class="col-3 ms-2 text-end p-0"><i class="bi bi-copy fs-10"></i></div>
                        <div class="col-3 fs-7 text-end pt-1" id="accountNumber">123456789123</div>
                    </div>
                    <div class="row">
                        <div class="col-6 fs-7">Atas Nama</div>
                        <div class="col-6 fs-7 text-end ms-auto">Indra Pratama</div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn kuning text-white fs-6 fw-bold py-2 px-3"
                        onclick="copyAccountNumber({{ $transactionId }})" wire:click="hapus">
                        Bayar
                    </button>
                </div>
            </div>
